                    ...
                    <form action="{{route(''), $user}}" method="POST" ><!--enctype="multipart/form-data", sirve para enviar imagen -->
                        ...
                        <div class="form-row mx-auto">
                            <div class="form-group col-md-7">
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" name="nombreEmpresa" class="form-control" id="nombreEmpresa"
                        ...
                        <div class="form-group col-mt-3">
                            <div class="input-group mb-1">
                                ...
                                <input type="text" name="permanencia" 
                                    @if (!empty($experienciaLaboral))
                                        value="{{$experienciaLaboral->permanencia}}"
                                    @else
                                        value=""
                                    @endif
                                value="{{old('permanencia')}}" class="form-control" id="permanencia" autofocus>
                            </div>
                        </div>
                        <div class="form-group col-mt-3">
                            ...
                            <div class="form-group col-md-7">
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" name="materia" class="form-control" id="materia" 
                                        @if (!empty($experienciaDocente))
                                            value="{{$experienciaDocente->materia}}"
                                        @else
                                            value=""
                                        @endif
                                    autofocus>
                            ...
                            <div class="form-group col-md-5">
                                <div class="input-group mb-1">
                                    ...
                                    <select class = "preriodo form-control" name="preriodo" id="preriodo">
                                        @if (!empty($experienciaDocente))
                                            <option value="{{$experienciaDocente->periodo}}">{{$experienciaDocente->periodo}}</option>    
                                        @else
