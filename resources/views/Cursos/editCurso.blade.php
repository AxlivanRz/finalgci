    ...
    <div class="row ">
     ...
     <div class="col-md-10">
        <div class="card ">
            ...
            <br>
            <div class = "col-md-12">
                <form action="{{route('Curso.update',$curso->id_Curso)}}" method="POST" ><!--enctype="multipart/form-data", sirve para enviar imagen -->
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            value="{{$curso->nombre_Servicio}}">
                        </div>
                        <div class="form-group col-md-3">
                            <label>Introducción</label>
                            <textarea type="text" class="form-control" id = "introduccionCur" name="introduccionCur"  required>
                                {{$curso->introduccion}}
                            </textarea>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Justificación</label>
                            <textarea type="text" class="form-control" id= "justificacionCur" name= "justificacionCur" required>
                                {{$curso->justificacion}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <textarea type="text" class="form-control" id="objetivoCur" name="objetivoCur" required>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            value="{{$curso->especificar_Servicio}}">
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            value="{{$curso->duracion_HCurso}}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="fechaI">Fecha de inicio</label>
                            <input type="date" class="form-control" id="fechaI" name="fechaI" data-inputmask-alias="date"
                             data-inputmask-inputformat="dd/mm/yyyy" data-mask="" inputmode="numeric" value="{{$curso->fecha_Inicio}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="time" class="form-control" id="horaE" name="horaE" required value="{{$curso->hora_Inicio}}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="horaS">Hora de salida</label>
                            <input type="time" id="horaS" name="horaS" class="form-control"inputmode="numeric" required value="{{$curso->hora_Salida}}">
                        </div> 
                        <div class="form-group col-md-4">
                            <label for="fechaF">Fecha final de curso</label>
                            <input type="date" class="form-control" id="fechaF" name="fechaF" data-inputmask-alias="date" 
                            data-inputmask-inputformat="dd/mm/yyyy" data-mask="" inputmode="numeric" value="{{$curso->fecha_Termino}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <textarea type="text" class="form-control" id ="elementosCur" name="elementosCur" required>
                                {{$curso->elementos_Desarrollo_Curso}}
                            </textarea>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Competencias a desarrollar</label>
                            <textarea class="form-control" id="competenciasCur" name="competenciasCur" placeholder="Enter ..."required>
                                {{$curso->competencias_Desarrollar}}
                            </textarea>
                        </div>
                        <div class="form-group col-md-3 ">
                            <label>Fuentes de información</label>
                            <textarea class="form-control" id="fuentesCur" name="fuentesCur" placeholder="Enter ..."required>
                                {{$curso->fuentes_Informacion}}
                            </textarea>
                        </div>
                    </div>
            </div>
